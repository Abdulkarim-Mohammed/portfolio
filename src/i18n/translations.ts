...
export const translations = {
  ...
  ar: {
    ...
    about: {
      ...
      bio1:        'أنا <strong class="text-white">طالب تقنية معلومات</strong> في <span class="font-[500] text-[var(--color-primary)]">الجامعة الإسلامية بالمدينة المنورة</span>، شغوف بصناعة تجارب ويب حديثة وبناء تطبيقات حقيقية تحل مشكلات الحياة اليومية.',
    ...
    contact: {
      ...
      title:       'تواصل',
      headline:    'لنتحدث',
      subheadline: 'يسعدني دائماً سماع أي مشاريع أو فرص جديدة. سواء كان لديك سؤال أو أردت مجرد إلقاء التحية، لا تتردد في التواصل معي!',
